...
const STATIC_PAGES = [
  ...
  // Subtopic pages — Esprit
  { url: '/univers/esprit/emotions', priority: 0.6, changefreq: 'weekly' },
  { url: '/univers/esprit/conscience', priority: 0.6, changefreq: 'weekly' },
  { url: '/univers/esprit/meditation', priority: 0.6, changefreq: 'weekly' },
  { url: '/univers/esprit/developpement-personnel', priority: 0.6, changefreq: 'weekly' },
  { url: '/univers/esprit/neurosciences', priority: 0.6, changefreq: 'weekly' },
  { url: '/univers/esprit/philosophie', priority: 0.6, changefreq: 'weekly' },
  { url: '/univers/esprit/quete-de-sens', priority: 0.6, changefreq: 'weekly' },
  { url: '/univers/esprit/therapies', priority: 0.6, changefreq: 'weekly' },
  // Subtopic pages — Corps
  { url: '/univers/corps/nutrition', priority: 0.6, changefreq: 'weekly' },
  { url: '/univers/corps/sommeil', priority: 0.6, changefreq: 'weekly' },
  { url: '/univers/corps/mouvement', priority: 0.6, changefreq: 'weekly' },
  { url: '/univers/corps/prevention', priority: 0.6, changefreq: 'weekly' },
  { url: '/univers/corps/medecine-douce', priority: 0.6, changefreq: 'weekly' },
  { url: '/univers/corps/bien-etre', priority: 0.6, changefreq: 'weekly' },
  { url: '/univers/corps/sport', priority: 0.6, changefreq: 'weekly' },
  { url: '/univers/corps/respiration', priority: 0.6, changefreq: 'weekly' },
  // Subtopic pages — Liens
  { url: '/univers/liens/parentalite', priority: 0.6, changefreq: 'weekly' },
  { url: '/univers/liens/couples', priority: 0.6, changefreq: 'weekly' },
  { url: '/univers/liens/amitie', priority: 0.6, changefreq: 'weekly' },
  { url: '/univers/liens/education', priority: 0.6, changefreq: 'weekly' },
  { url: '/univers/liens/generations', priority: 0.6, changefreq: 'weekly' },
  { url: '/univers/liens/communaute', priority: 0.6, changefreq: 'weekly' },
  { url: '/univers/liens/ruptures', priority: 0.6, changefreq: 'weekly' },
  { url: '/univers/liens/enquetes-sociales', priority: 0.6, changefreq: 'weekly' },
  // Subtopic pages — Monde
  { url: '/univers/monde/recits-voyage', priority: 0.6, changefreq: 'weekly' },
  { url: '/univers/monde/destinations', priority: 0.6, changefreq: 'weekly' },
  { url: '/univers/monde/art', priority: 0.6, changefreq: 'weekly' },
  { url: '/univers/monde/musique', priority: 0.6, changefreq: 'weekly' },
  { url: '/univers/monde/litterature', priority: 0.6, changefreq: 'weekly' },
  { url: '/univers/monde/cinema', priority: 0.6, changefreq: 'weekly' },
  { url: '/univers/monde/creativite', priority: 0.6, changefreq: 'weekly' },
  { url: '/univers/monde/photographie', priority: 0.6, changefreq: 'weekly' },
  // Subtopic pages — Avenir
  { url: '/univers/avenir/carriere', priority: 0.6, changefreq: 'weekly' },
  { url: '/univers/avenir/entrepreneuriat', priority: 0.6, changefreq: 'weekly' },
  { url: '/univers/avenir/innovation', priority: 0.6, changefreq: 'weekly' },
  { url: '/univers/avenir/ia', priority: 0.6, changefreq: 'weekly' },
  { url: '/univers/avenir/economie', priority: 0.6, changefreq: 'weekly' },
  { url: '/univers/avenir/leadership', priority: 0.6, changefreq: 'weekly' },
  { url: '/univers/avenir/numerique', priority: 0.6, changefreq: 'weekly' },
  { url: '/univers/avenir/nomadisme', priority: 0.6, changefreq: 'weekly' },
