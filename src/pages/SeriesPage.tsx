...
const PLACEHOLDER_IMAGES = [
  '/series/01_transmission.webp',
  '/series/02_etat_esprit.webp',
  '/series/03_il_etait_une_fois.webp',
  '/series/04_secrets_professionnels.webp',
  '/series/05_la_lettre.webp',
  '/series/06_imagine.webp',
  '/academy/masterclass-storytelling.webp',
  '/academy/guide-mindset.webp',
  '/academy/programme-complet.webp',
  '/kit-introspection.webp',
];
...
const seriesData: Serie[] = [
  {
    ...
    posterUrl: '/series/01_transmission_poster.webp',
    bannerUrl: '/series/01_transmission.webp',
    couleur: '#6366F1',
    nombreEpisodes: 15,
    nombreSaisons: 2,
    annee: '2024',
  ...
  },
  {
    ...
    posterUrl: '/series/02_etat_esprit_poster.webp',
    bannerUrl: '/series/02_etat_esprit.webp',
    couleur: '#0EA5E9',
    nombreEpisodes: 19,
    nombreSaisons: 2,
    annee: '2024',
  ...
  },
  {
    ...
    posterUrl: '/series/03_il_etait_une_fois_poster.webp',
    bannerUrl: '/series/03_il_etait_une_fois.webp',
    couleur: '#EAB308',
    nombreEpisodes: 32,
    nombreSaisons: 3,
    annee: '2023',
  ...
  },
  {
    ...
    posterUrl: '/series/04_secrets_professionnels_poster.webp',
    bannerUrl: '/series/04_secrets_professionnels.webp',
    couleur: '#EC4899',
    nombreEpisodes: 18,
    nombreSaisons: 2,
    annee: '2024',
  ...
  },
  {
    ...
    posterUrl: '/series/05_la_lettre_poster.webp',
    bannerUrl: '/series/05_la_lettre.webp',
    couleur: '#10B981',
    nombreEpisodes: 24,
    nombreSaisons: 2,
    annee: '2024',
  ...
  },
  {
    ...
    posterUrl: '/series/06_imagine_poster.webp',
    bannerUrl: '/series/06_imagine.webp',
    couleur: '#8B5CF6',
    nombreEpisodes: 12,
    nombreSaisons: 1,
    annee: '2024',
