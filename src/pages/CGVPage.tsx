      ...
      <main>
        <header className={s.header}>
          <div className={s.headerInner}>
            ...
            <h1 className={s.headerTitle}>Conditions Générales de Vente</h1>
        ...
        <div className={s.content}>
          ...
          {/* Article 1 */}
          <div className={s.section}>
            <h2 className={s.sectionTitle}>Article 1 – Identification du Vendeur</h2>
          ...
          {/* Article 2 */}
          <div className={s.section}>
            <h2 className={s.sectionTitle}>Article 2 – Produits</h2>

            <h3 className={s.sectionSubtitle}>2.1 Description</h3>
            <p className={s.text}>
            ...
            <h3 className={s.sectionSubtitle}>2.2 Disponibilité</h3>
            <p className={s.text}>
          ...
          {/* Article 3 */}
          <div className={s.section}>
            <h2 className={s.sectionTitle}>Article 3 – Prix</h2>

            <h3 className={s.sectionSubtitle}>3.1 Tarifs</h3>
            <p className={s.text}>
            ...
            <h3 className={s.sectionSubtitle}>3.2 Offres promotionnelles</h3>
            <p className={s.text}>
          ...
          {/* Article 4 */}
          <div className={s.section}>
            <h2 className={s.sectionTitle}>Article 4 – Commande</h2>

            <h3 className={s.sectionSubtitle}>4.1 Processus de commande</h3>
            <p className={s.text}>Pour passer commande, le client doit :</p>
            <ul className={s.list}>
            ...
            <h3 className={s.sectionSubtitle}>4.2 Confirmation de commande</h3>
            <p className={s.text}>
            ...
            <h3 className={s.sectionSubtitle}>4.3 Preuve de la transaction</h3>
            <p className={s.text}>
          ...
          {/* Article 5 */}
          <div className={s.section}>
            <h2 className={s.sectionTitle}>Article 5 – Paiement</h2>

            <h3 className={s.sectionSubtitle}>5.1 Moyens de paiement acceptés</h3>
            <p className={s.text}>Le client peut régler sa commande par les moyens de paiement suivants :</p>
            <ul className={s.list}>
            ...
            <h3 className={s.sectionSubtitle}>5.2 Sécurité des paiements</h3>
            <p className={s.text}>
            ...
            <h3 className={s.sectionSubtitle}>5.3 Validation du paiement</h3>
            <p className={s.text}>
          ...
          {/* Article 6 */}
          <div className={s.section}>
            <h2 className={s.sectionTitle}>Article 6 – Livraison</h2>

            <h3 className={s.sectionSubtitle}>6.1 Modalités de livraison</h3>
            <p className={s.text}>
            ...
            <p className={s.text}>L'email de livraison contient :</p>
            <ul className={s.list}>
              <li>Le(s) fichier(s) en pièce jointe, et/ou</li>
              <li>Un lien de téléchargement sécurisé</li>
            </ul>

            <h3 className={s.sectionSubtitle}>6.2 Délai de livraison</h3>
            <p className={s.text}>
            ...
            <h3 className={s.sectionSubtitle}>6.3 Problèmes de livraison</h3>
            <p className={s.text}>En cas de non-réception de l'email de livraison :</p>
            <ul className={s.list}>
          ...
          {/* Article 7 */}
          <div className={s.section}>
            <h2 className={s.sectionTitle}>Article 7 – Droit de Rétractation</h2>

            <h3 className={s.sectionSubtitle}>7.1 Principe</h3>
            <p className={s.text}>
            ...
            <h3 className={s.sectionSubtitle}>7.2 Exception pour les contenus numériques</h3>
            <div className={s.infoBox}>
              <p>
            ...
            <h3 className={s.sectionSubtitle}>7.3 Renonciation au droit de rétractation</h3>
            <p className={s.text}>
            ...
            <h3 className={s.sectionSubtitle}>7.4 Conséquence</h3>
            <p className={s.text}>
          ...
          {/* Article 8 */}
          <div className={s.section}>
            <h2 className={s.sectionTitle}>Article 8 – Garanties Légales</h2>

            <h3 className={s.sectionSubtitle}>8.1 Garantie de conformité</h3>
            <p className={s.text}>
            ...
            <h3 className={s.sectionSubtitle}>8.2 Garantie des vices cachés</h3>
            <p className={s.text}>
            ...
            <h3 className={s.sectionSubtitle}>8.3 Mise en œuvre</h3>
            <p className={s.text}>
          ...
          {/* Article 9 */}
          <div className={s.section}>
            <h2 className={s.sectionTitle}>Article 9 – Propriété Intellectuelle</h2>

            <h3 className={s.sectionSubtitle}>9.1 Droits d'auteur</h3>
            <p className={s.text}>
            ...
            <h3 className={s.sectionSubtitle}>9.2 Interdictions</h3>
            <p className={s.text}>Le client s'interdit expressément de :</p>
            <ul className={s.list}>
            ...
            <h3 className={s.sectionSubtitle}>9.3 Sanctions</h3>
            <p className={s.text}>
          ...
          {/* Article 10 */}
          <div className={s.section}>
            <h2 className={s.sectionTitle}>Article 10 – Responsabilité</h2>

            <h3 className={s.sectionSubtitle}>10.1 Limitation de responsabilité</h3>
            ...
            <h3 className={s.sectionSubtitle}>10.2 Force majeure</h3>
            <p className={s.text}>
          ...
          {/* Article 11 */}
          <div className={s.section}>
            <h2 className={s.sectionTitle}>Article 11 – Données Personnelles</h2>
            <p className={s.text}>
          ...
          {/* Article 12 */}
          <div className={s.section}>
            <h2 className={s.sectionTitle}>Article 12 – Service Client</h2>
            <p className={s.text}>
          ...
          {/* Article 13 */}
          <div className={s.section}>
            <h2 className={s.sectionTitle}>Article 13 – Médiation</h2>

            <h3 className={s.sectionSubtitle}>13.1 Réclamation préalable</h3>
            <p className={s.text}>
            ...
            <h3 className={s.sectionSubtitle}>13.2 Médiation de la consommation</h3>
            <p className={s.text}>
            ...
            <div className={s.infoBox}>
              <p><strong>Médiateur compétent :</strong></p>
              <p>Médiateur du e-commerce de la FEVAD</p>
              <p>60 rue La Boétie, 75008 Paris</p>
              <p><a href="https://www.mediateurfevad.fr" target="_blank" rel="noopener noreferrer">https://www.mediateurfevad.fr</a></p>
              <p>Formulaire de saisine en ligne : <a href="https://www.mediateurfevad.fr/index.php/espace-consommateur/" target="_blank" rel="noopener noreferrer">https://www.mediateurfevad.fr/index.php/espace-consommateur/</a></p>
            </div>
            <p className={s.text}>
              Le client peut également utiliser la plateforme européenne de règlement en ligne des litiges : <a href="https://ec.europa.eu/consumers/odr" target="_blank" rel="noopener noreferrer">https://ec.europa.eu/consumers/odr</a>
            </p>
          </div>

          {/* Article 14 */}
          <div className={s.section}>
            <h2 className={s.sectionTitle}>Article 14 – Droit Applicable et Juridiction</h2>
            <p className={s.text}>
          ...
          {/* Article 15 */}
          <div className={s.section}>
            <h2 className={s.sectionTitle}>Article 15 – Modification des CGV</h2>
            <p className={s.text}>
          ...
          {/* Article 16 */}
          <div className={s.section}>
            <h2 className={s.sectionTitle}>Article 16 – Nullité Partielle</h2>
            <p className={s.text}>
          ...
          {/* Annexe */}
          <div className={s.section}>
            <h2 className={s.sectionTitle}>Annexe – Modèle de Formulaire de Réclamation</h2>
            <div className={s.infoBox}>
              <p><strong>À :</strong> ADN Production SAS – 40 Avenue de Saint-Antoine, 13015 Marseille – admin@origines.media</p>
              <p style={{ marginTop: 16 }}>Je soussigné(e) [Nom, Prénom], demeurant à [Adresse], souhaite signaler un problème concernant ma commande :</p>
              <ul className={s.list}>
              ...
              <p style={{ marginTop: 16 }}>Fait à _______________, le _______________</p>
