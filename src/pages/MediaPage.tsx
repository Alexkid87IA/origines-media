...
function sanityToSlide(a: SanitySlide, index: number): Slide {
  ...
  return {
    ...
    readTime: `Lecture ${a.tempsLecture || estimateReadingTimeFromText(a.contenuTexte) || 5} min`,
    href: `/article/${a.slug || ""}`,
...
function sanityToFeedItem(a: SanityFeedArticle, idx: number): CMSFeedItem {
  ...
  return {
    ...
    readTime: isVideo ? (a.duree || "Vidéo") : `${a.tempsLecture || estimateReadingTimeFromText(a.contenuTexte) || 5} min`,
    isVideo,
