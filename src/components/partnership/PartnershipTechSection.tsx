      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
        ...
        <div className={`text-center mb-12 sm:mb-16 lg:mb-20 transition-all duration-1000 ${
          ...
          <h2 className="font-montserrat font-black uppercase leading-tight mb-3 sm:mb-4">
            <span className="block text-3xl sm:text-5xl lg:text-7xl text-white tracking-tight">
              LA TECH
            </span>
          ...
          {/* Sous-titre enrichi */}
          <p className="text-base sm:text-xl lg:text-2xl text-white/70 max-w-3xl mx-auto">
          ...
          {/* Punchline */}
          <p className="text-sm sm:text-base text-white/50 font-medium mt-4 sm:mt-6 max-w-2xl mx-auto">
          ...
          <div className="max-w-4xl mx-auto text-left mt-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mt-8 sm:mt-10">
              <div className="text-center p-4 sm:p-6 bg-white/5 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-white/10">
                ...
                <h4 className="font-bold text-white mb-1 sm:mb-2 text-sm sm:text-base">IA Valuator</h4>
                <p className="text-xs sm:text-sm text-white/60">Estime la valeur en 3 secondes</p>
              </div>
              <div className="text-center p-4 sm:p-6 bg-white/5 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-white/10">
                <div className="w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-3 bg-gradient-to-br from-purple-400 to-pink-400 rounded-full flex items-center justify-center">
                  <GitBranch className="w-6 sm:w-8 h-6 sm:h-8 text-white" />
                </div>
                <h4 className="font-bold text-white mb-1 sm:mb-2 text-sm sm:text-base">Matching Engine</h4>
                <p className="text-xs sm:text-sm text-white/60">Trouve les échanges multi-parties</p>
              </div>
              <div className="text-center p-4 sm:p-6 bg-white/5 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-white/10">
                ...
                <h4 className="font-bold text-white mb-1 sm:mb-2 text-sm sm:text-base">Impact Tracker</h4>
                <p className="text-xs sm:text-sm text-white/60">Mesure et valorise chaque geste</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className={`mb-12 sm:mb-16 lg:mb-20 transition-all duration-1000 delay-200 ${
          ...
          <div className="relative bg-gradient-to-br from-cyan-500/10 to-blue-500/10 backdrop-blur-sm rounded-2xl sm:rounded-3xl p-6 sm:p-10 lg:p-16 border border-cyan-500/20 overflow-hidden">
            ...
            <div className="relative grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
              <div>
                <h3 className="font-montserrat font-bold text-xl sm:text-2xl lg:text-3xl text-white mb-4 sm:mb-6 flex items-center gap-2 sm:gap-3">
                ...
                <div className="space-y-3 sm:space-y-4 text-white/80">
                  ...
                  <div className="bg-black/30 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-cyan-500/30">
                    <div className="space-y-2 font-mono text-xs sm:text-sm">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-white/80 truncate">VTT Decathlon Rockrider 540</span>
                      </div>
                      <div className="flex items-center gap-2">
              ...
              <div className="relative">
                ...
                <div className="relative w-full h-60 sm:h-80 bg-black/20 rounded-xl sm:rounded-2xl border border-cyan-500/30 overflow-hidden">
                  ...
                  {/* Progress bar */}
                  <div className="absolute bottom-0 left-0 right-0 h-1.5 sm:h-2 bg-black/50">
        ...
        <div className={`mb-12 sm:mb-16 lg:mb-20 transition-all duration-1000 delay-400 ${
          ...
          <div className="relative bg-gradient-to-br from-purple-500/10 to-pink-500/10 backdrop-blur-sm rounded-2xl sm:rounded-3xl p-6 sm:p-10 lg:p-16 border border-purple-500/20">
            <h3 className="font-montserrat font-bold text-xl sm:text-2xl lg:text-3xl text-white mb-4 sm:mb-6 flex items-center gap-2 sm:gap-3">
            ...
            <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
              <div className="order-2 lg:order-1">
                ...
                <div className="relative h-60 sm:h-80">
                  ...
                  <div className={`absolute top-0 left-1/2 -translate-x-1/2 transition-all duration-1000 ${
                    ...
                    <p className="text-center text-white/80 mt-1 sm:mt-2 font-semibold text-sm sm:text-base">Marie</p>
                    <p className="text-center text-white/60 text-xs sm:text-sm">Vélo (280€)</p>
                  </div>
                  ...
                  <div className={`absolute bottom-0 left-0 transition-all duration-1000 ${
                    ...
                    <p className="text-center text-white/80 mt-1 sm:mt-2 font-semibold text-sm sm:text-base">Paul</p>
                    <p className="text-center text-white/60 text-xs sm:text-sm">Cours + PS4</p>
                  </div>
                  ...
                  <div className={`absolute bottom-0 right-0 transition-all duration-1000 ${
                    ...
                    <p className="text-center text-white/80 mt-1 sm:mt-2 font-semibold text-sm sm:text-base">Sophie</p>
                    <p className="text-center text-white/60 text-xs sm:text-sm">Veut les cours</p>
                  </div>
              ...
              <div className="order-1 lg:order-2 space-y-3 sm:space-y-4 text-white/80">
                <p className="text-sm sm:text-base lg:text-lg">
                  L'algo détecte : <span className="font-bold text-purple-400">échange triangulaire possible</span>
                </p>
                
                <div className="space-y-2 sm:space-y-3">
                  <div className="flex items-center gap-2 sm:gap-3 p-3 sm:p-4 bg-black/30 rounded-lg sm:rounded-xl border border-purple-500/30">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs sm:text-sm text-white/60">Valeur : 280€</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2 sm:gap-3 p-3 sm:p-4 bg-black/30 rounded-lg sm:rounded-xl border border-purple-500/30">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs sm:text-sm text-white/60">Valeur : 190€ + 90€</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2 sm:gap-3 p-3 sm:p-4 bg-black/30 rounded-lg sm:rounded-xl border border-purple-500/30">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs sm:text-sm text-white/60">Service ou futur crédit</p>
                    </div>
                  </div>
                </div>
        ...
        <div className={`mb-12 sm:mb-16 lg:mb-20 transition-all duration-1000 delay-600 ${
          ...
          <div className="relative bg-gradient-to-br from-green-500/10 to-emerald-500/10 backdrop-blur-sm rounded-2xl sm:rounded-3xl p-6 sm:p-10 lg:p-16 border border-green-500/20">
            <h3 className="font-montserrat font-bold text-xl sm:text-2xl lg:text-3xl text-white mb-6 sm:mb-8 flex items-center gap-2 sm:gap-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
              {/* Live Overlay */}
              <div className="bg-black/30 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-green-500/30">
                <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                  <Zap className="w-5 sm:w-6 h-5 sm:h-6 text-green-400" />
                  <h4 className="font-semibold text-white text-sm sm:text-base">Overlay Live</h4>
                </div>
              ...
              <div className="bg-black/30 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-green-500/30">
                <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                  ...
                  <h4 className="font-semibold text-white text-sm sm:text-base">API Ouverte</h4>
                </div>
                ...
                <div className="space-y-1 sm:space-y-2 font-mono text-[10px] sm:text-xs">
                  <div className="p-1.5 sm:p-2 bg-black/50 rounded text-green-400 overflow-x-auto">
              ...
              {/* Score de Réputation */}
              <div className="bg-black/30 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-green-500/30 sm:col-span-2 lg:col-span-1">
                <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                  <Shield className="w-5 sm:w-6 h-5 sm:h-6 text-green-400" />
                  <h4 className="font-semibold text-white text-sm sm:text-base">Score de Réputation</h4>
                </div>
                <p className="text-white/80 text-xs sm:text-sm mb-3 sm:mb-4">
                ...
                <div className="space-y-2 sm:space-y-3">
                  <div className="flex items-center gap-2">
                    <div className="flex-1 h-1.5 sm:h-2 bg-black/50 rounded-full overflow-hidden">
                      <div className="h-full w-4/5 bg-gradient-to-r from-green-400 to-emerald-400 rounded-full" />
                    </div>
                    <span className="text-white/80 text-xs sm:text-sm font-semibold">Niveau 8</span>
                  </div>
        ...
        <div className="mt-16 sm:mt-24 lg:mt-32">
          <h3 className="font-montserrat font-bold text-xl sm:text-2xl lg:text-3xl text-white text-center mb-8 sm:mb-12">
          ...
          <div className={`mb-12 sm:mb-16 transition-all duration-1000 delay-1000 ${
            ...
            <h4 className="font-montserrat font-bold text-lg sm:text-xl text-white text-center mb-6 sm:mb-8 flex items-center justify-center gap-2 sm:gap-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              {/* Wanted Channel */}
              <div className="bg-gradient-to-br from-orange-500/10 to-red-500/10 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-orange-500/20">
              ...
              {/* Origines Channel */}
              <div className="bg-gradient-to-br from-violet-500/10 to-purple-500/10 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-violet-500/20">
              ...
              {/* Viral Effect */}
              <div className="bg-gradient-to-br from-pink-500/10 to-orange-500/10 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-pink-500/20 sm:col-span-2 lg:col-span-1">
          ...
          <div className={`transition-all duration-1000 delay-1200 ${
            ...
            <h4 className="font-montserrat font-bold text-lg sm:text-xl text-white text-center mb-6 sm:mb-8 flex items-center justify-center gap-2 sm:gap-3 flex-wrap px-4">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4 mb-6 sm:mb-8">
              <div className="bg-black/40 backdrop-blur-sm rounded-lg sm:rounded-xl p-3 sm:p-4 border border-green-500/20 text-center">
                <CreditCard className="w-5 sm:w-6 h-5 sm:h-6 text-green-400 mx-auto mb-1.5 sm:mb-2" />
                <h5 className="font-bold text-white text-xs sm:text-sm mb-0.5 sm:mb-1">Crédits Troc</h5>
                <p className="text-green-400 font-bold text-xs sm:text-sm">1€ = 1 crédit</p>
                <p className="text-[10px] sm:text-xs text-white/60 mt-0.5 sm:mt-1">Compenser les écarts</p>
              ...
              <div className="bg-black/40 backdrop-blur-sm rounded-lg sm:rounded-xl p-3 sm:p-4 border border-green-500/20 text-center">
                ...
                <h5 className="font-bold text-white text-xs sm:text-sm mb-0.5 sm:mb-1">Abonnements</h5>
                <p className="text-green-400 font-bold text-xs sm:text-sm">9-99€/mois</p>
                <p className="text-[10px] sm:text-xs text-white/60 mt-0.5 sm:mt-1">Features premium</p>
              ...
              <div className="bg-black/40 backdrop-blur-sm rounded-lg sm:rounded-xl p-3 sm:p-4 border border-green-500/20 text-center">
                ...
                <h5 className="font-bold text-white text-xs sm:text-sm mb-0.5 sm:mb-1">Sponsors</h5>
                <p className="text-green-400 font-bold text-xs sm:text-sm">5-20k€/mois</p>
                <p className="text-[10px] sm:text-xs text-white/60 mt-0.5 sm:mt-1">Par verticale</p>
              ...
              <div className="bg-black/40 backdrop-blur-sm rounded-lg sm:rounded-xl p-3 sm:p-4 border border-green-500/20 text-center">
                ...
                <h5 className="font-bold text-white text-xs sm:text-sm mb-0.5 sm:mb-1">Data & API</h5>
                <p className="text-green-400 font-bold text-xs sm:text-sm">1-10k€</p>
                <p className="text-[10px] sm:text-xs text-white/60 mt-0.5 sm:mt-1">ESG, recherche</p>
                <p className="text-[10px] sm:text-xs text-green-400 font-semibold mt-1.5 sm:mt-2">200k€/an</p>
              </div>

              <div className="bg-black/40 backdrop-blur-sm rounded-lg sm:rounded-xl p-3 sm:p-4 border border-green-500/20 text-center col-span-2 sm:col-span-1">
                <Package className="w-5 sm:w-6 h-5 sm:h-6 text-green-400 mx-auto mb-1.5 sm:mb-2" />
                <h5 className="font-bold text-white text-xs sm:text-sm mb-0.5 sm:mb-1">Services+</h5>
                <p className="text-green-400 font-bold text-xs sm:text-sm">2-10€</p>
                <p className="text-[10px] sm:text-xs text-white/60 mt-0.5 sm:mt-1">Livraison, assurance</p>
                <p className="text-[10px] sm:text-xs text-green-400 font-semibold mt-1.5 sm:mt-2">100k€/an</p>
              </div>
            </div>

            {/* Detail Data & Analytics */}
            <div className="bg-gradient-to-br from-emerald-500/10 to-green-500/10 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-emerald-500/20 mb-6 sm:mb-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 text-xs sm:text-sm">
                <div>
                  <p className="text-white font-semibold mb-0.5 sm:mb-1">Rapports ESG</p>
                  <p className="text-white/60">CO2 évité, impact social certifié pour entreprises</p>
                </div>
                <div>
                  <p className="text-white font-semibold mb-0.5 sm:mb-1">API Recherche</p>
                  <p className="text-white/60">Données anonymisées pour universités</p>
                </div>
                <div>
                  <p className="text-white font-semibold mb-0.5 sm:mb-1">Baromètre Wanted</p>
                  <p className="text-white/60">Tendances du troc vendues aux médias</p>
                </div>
                <div>
                  <p className="text-white font-semibold mb-0.5 sm:mb-1">Insights Marques</p>
            ...
            <div className="mt-8 sm:mt-12 grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 text-center">
              <div className="p-4 sm:p-6 bg-gradient-to-br from-violet-500/10 to-purple-500/10 rounded-xl sm:rounded-2xl border border-violet-500/20">
                ...
                <p className="text-xl sm:text-2xl font-bold text-white">100k users</p>
                <p className="text-white/60 text-xs sm:text-sm mt-1">2M€ GMV • 100k€ revenus</p>
              </div>
              ...
              <div className="p-4 sm:p-6 bg-gradient-to-br from-pink-500/10 to-orange-500/10 rounded-xl sm:rounded-2xl border border-pink-500/20">
                ...
                <p className="text-xl sm:text-2xl font-bold text-white">500k users</p>
                <p className="text-white/60 text-xs sm:text-sm mt-1">10M€ GMV • 1M€ revenus</p>
              </div>
              ...
              <div className="p-4 sm:p-6 bg-gradient-to-br from-green-500/10 to-emerald-500/10 rounded-xl sm:rounded-2xl border border-green-500/20">
                ...
                <p className="text-xl sm:text-2xl font-bold text-white">2M users</p>
                <p className="text-white/60 text-xs sm:text-sm mt-1">50M€ GMV • 5M€ revenus</p>
              </div>
            </div>
          </div>
        </div>
