...
const GALAXIE = [
  {
    ...
    items: [
      ...
      { label: "Actualités", href: "/discover" },
  ...
  },
  {
    id: "ateliers",
    name: "Guides",
    tagline: "Masterclass, ateliers, parcours et kits gratuits.",
    color: "#059669",
    href: "/guides",
    items: [
...
const SECONDARY: SecondaryNav[] = [
  {
    ...
    secondaryItems: [
      ...
      { href: "/discover", label: "Actualités", color: "#E67839" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/guides/programmes", label: "Parcours", color: "#2E9B74" },
